...
import com.gastro.utility.DropdownManagerEmployee;
...
public class EmployeesView extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DropdownManagerEmployee dropdownManager = new DropdownManagerEmployee(this, R.menu.dropdown_menu, R.id.imageMenu);
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("inEmployee", getIntent().getBooleanExtra("inEmployee", true));
    ...
    private void showStartWorkDialog() {
        ...
        text.setText(workData != null && workData.containsKey(date) && workData.get(date).contains("x") ? getString(R.string.continue_working) : getString(R.string.start_working));
