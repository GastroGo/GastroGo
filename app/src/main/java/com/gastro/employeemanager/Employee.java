...
public class Employee extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                EmployeeItem employee = snapshot.child(restaurantID + "/" + employeeID).getValue(EmployeeItem.class);
                if (employee != null){
        ...
        //dbRef.child("/Schluessel").addValueEventListener(valueEventListener);
    ...
    public void showEditDialog(String dateToEdit){
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (date.equalsIgnoreCase(getString(R.string.date)) | startTime.equalsIgnoreCase(getString(R.string.start)) | endTime.equalsIgnoreCase(getString(R.string.finish))){
                    return;
                }
    ...
    public void showAddDialog(){
        ...
        selectStartTimeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String startTime = (String) selectStartTimeButton.getText();
                if (startTime.equalsIgnoreCase(getString(R.string.start))){
        ...
        selectEndTimeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String endTime = (String) selectEndTimeButton.getText();
                if (endTime.equalsIgnoreCase(getString(R.string.finish))){
    ...
    public void showDeleteDialog(String date){
        ...
        text.setText(date.substring(0, 2) + "." + date.substring(2, 4) + "." + date.substring(4) + getString(R.string.really_delete));
